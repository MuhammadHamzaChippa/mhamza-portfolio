    ...
    return (
        <Section bg={bg}>
            ...
            >
                ...
                >
                    <AnimationContainer imageSide={imageSide === "right" ? false : true} duration={1000}>
                        <Repeater
                            propName="badge"
                            renderWrapper={(items) => (
                                <div
                    ...
                    <AnimationContainer imageSide={imageSide === "right" ? false : true} duration={1500}>
                        <div>
                            <Repeater
                                ...
                                renderWrapper={(items) => <div className="mt-4 mb-4 w-full ">{items}</div>}
                            />
                                <>
                                    <RichText
                                        propName="technology"
                                    ...
                                    <Repeater
                                        ...
                                        renderWrapper={(items) => (
                                            <div className="mt-4 w-full grid lg:grid-cols-3 md:grid-cols-2 grid-cols-5 gap-[15px] ">
                                                {items}
                                            </div>
                                        )}
                                    />
                    ...
                    <Repeater
                        propName="buttons"
                        renderWrapper={(items) => (
                            <div className="flex items-center flex-col sm:flex-row mt-4">{items}</div>
                        )}
                    />
                </div>
                {multiple ? (
                    ...
                    >
                        <AnimationContainer imageSide={imageSide === "right" ? true : false} duration={2000}>
                            <Image
...
CustomListImage.schema = {
    ...
    playgroundLinkUrl: "https://github.com/ReactBricks/react-bricks-ui/blob/master/src/website/TextImage/TextImage.tsx",
